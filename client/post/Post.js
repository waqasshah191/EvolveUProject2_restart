...
import { ThumbUp, ThumbDownAlt, InsertEmoticon, SentimentVeryDissatisfied } from '@material-ui/icons'
import CommentIcon from '@material-ui/icons/Comment'
import Divider from '@material-ui/core/Divider'
import PropTypes from 'prop-types'
import { makeStyles } from '@material-ui/core/styles'
import { Link } from 'react-router-dom'
import { remove, like, unlike, dislike, undislike } from './api-post.js'
...
export default function Post(props) {
  ...
  const [values, setValues] = useState({
    ...
    dislike: checkLike(props.post.dislikes),
    dislikes: props.post.dislikes.length,
  ...
  const clickDislike = () => {
    let callApi = values.dislike ? undislike : dislike
    callApi({
      userId: jwt.user._id
    }, {
      t: jwt.token
    ...
    <Card className={classes.card}>
      ...
      <CardActions>
        ...
        <IconButton
          ...
          color={values.like ? "secondary" : undefined}
        >
          <ThumbUp />
        </IconButton>
        ...
        <IconButton
          ...
          className={classes.button}
          aria-label={values.dislike ? 'Dislike' : 'Undislike'}
          color={values.dislike ? "secondary" : undefined}
        >
          <ThumbDownAlt />
        </IconButton>
